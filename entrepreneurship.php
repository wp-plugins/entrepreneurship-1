...
?>
	<?php settings_errors(); ?>
	<div class="wrap">
		<a href="http://disruptive.nu.com/"><div id="epo-icon" style="background: url(<?php echo plugins_url( '/images/heart_32x32.gif', __FILE__ ) ?>) no-repeat;" class="icon32"><br /></div></a>
...
function epo_general_section_text(){
	echo '<p>' . __('General settings for Entrepreneurship +1.', EPO_TEXT_DOMAIN ) . '</p>';
}
